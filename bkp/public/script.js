...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchUserProfile() {
        try {
            ...
            if (user) {
                // Atualiza o localStorage com os dados mais recentes, incluindo o apelido
                ...
                // Retorna o objeto de usuário completo para ser usado por outras funções
                return user;
            }
        } catch (error) {
    ...
    async function loadInitialData() {
        try {
            ...
            // ATUALIZAÇÃO CORRIGIDA: Usa a função de saudação do auth_menu.js
            // com os dados mais recentes do servidor.
            if (userData) {
