// /components/DataForm.vue - V2.8 - Adicionado emit('cancel') e botão para fechar o formulário.
<template>
...
// Estado para as medidas que o usuário está adicionando. 
// Inicializamos com a Cintura (ID 4)
const dynamicMeasurements = ref([{ id: 4, value: null }]);

// ... (Resto das funções e submitRecord mantidos da V2.7)
...
try {
 ...
 // Reseta as medidas dinâmicas para Cintura
 dynamicMeasurements.value = [{ id: 4, value: null }];
