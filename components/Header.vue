// /components/Header.vue - V1.14 - Adicionados ícones visuais (Font Awesome) para os itens do menu.
<template>
...
const closeMenu = (event) => {
  ...
  // Garantir que o clique fora do menu o feche
  if (!event.target.closest('.relative') || !menuContainer.contains(event.target)) {
