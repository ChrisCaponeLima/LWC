// /components/ProfileForm.vue - V4.1 - Inclusão do campo 'phone'
<template>
...
interface UserProfileData {
  ...
  phone: string | null; // Adicionado phone
}
...
const formData = reactive({
 ...
 phone: props.initialData.phone || '', // Adicionado phone
});
...
watch(() => props.initialData, (newVal) => {
 ...
 formData.phone = newVal.phone || ''; // *** AJUSTE CORRIGIDO AQUI ***
