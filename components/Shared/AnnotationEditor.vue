// /components/Shared/AnnotationEditor.vue - V2.2 - Correção de Vazamento Horizontal da Imagem
<template>
 <div 
  ref="editorContainerRef"
  class="relative w-full overflow-hidden" 
  :style="{ 
   // Mantido o controle de dimensão via style para estabilidade da V1.5
   // REFORÇADO: Adicionado max-width para garantir que não vazará para fora
   width: `${editorDimensions.width || 800}px`,
   height: `${editorDimensions.height || 500}px`,
   'max-width': '100%',
  }"
 ...
 >
  <img 
   ...
   @load="handleImageLoad"
      ...
      class="block max-w-full h-full object-contain pointer-events-none"
  />
