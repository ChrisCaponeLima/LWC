// /components/UserAddModal.vue - V1.6 - Adicionado campo 'phone' (telefone) ao formulário e script.
<template>
<div 
v-if="isOpen" 
...
phone: null, // <-- ADICIONADO CAMPO PHONE
}
...
// Garante que o campo de texto vazio ('') para phone seja null
phone: newUser.value.phone === '' ? null : newUser.value.phone, // <-- ADICIONADO CAMPO PHONE
