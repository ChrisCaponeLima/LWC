// /pages/chat/[partnerId].vue - V5.10 - Correção Final de Layout e Sincronização
...
<div class="h-screen bg-gray-100 flex flex-col pt-8 pb-8"> 
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 w-full flex flex-col">

<NuxtLink to="/chat" class="text-indigo-600 hover:text-indigo-800 mb-6 inline-block font-semibold flex-shrink-0">
 ← Voltar
</NuxtLink>

<div class="bg-white shadow-xl rounded-xl flex flex-col flex-1 min-h-0">
 
 <div class="p-4 border-b bg-gray-50 rounded-t-xl flex-shrink-0">
 ...
 <div class="p-4 border-t bg-white rounded-b-xl flex-shrink-0">
