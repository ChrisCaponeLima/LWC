...
try {
 ...
 headers: { 'Content-Type': 'application/json' }
  ...
  // 🚨 NOVO: Checagem Crítica do Token e userId
  if (!apiResponse || !apiResponse.token || !apiResponse.userId) {
    // Lança um erro específico que podemos tratar abaixo
 ...
 const userPayload = {
 id: apiResponse.userId, // ✅ Padronização: 'id' principal e compatibilidade
