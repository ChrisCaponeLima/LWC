// /pages/profile.vue - V1.2 Corrigido + Alterações de Layout
<template>
...
// 🛑 Protege a página usando o middleware.
definePageMeta({
    middleware: ['auth'],
});
...
const fetchProfileData = async () => {
    ...
    try {
        ...
        // CORREÇÃO: Caso o middleware falhe ou o token esteja ausente por algum motivo.
        if (!token) {
...
// --- 2. FUNÇÕES DA TABELA DE MEDIDAS (Replicadas de user_management) ---

const formatMeasurement = (value: number) => {
    return value.toFixed(1).replace('.', ',');
};

// Lógica de ícone de tendência: 'down' é positivo (verde) para perda de peso/medidas
...
// --- 4. Componente Reutilizável de Galeria (Definido Aqui Temporariamente) ---
</script>
