// /server/api/users.get.ts - V2.2 - Inclusão do campo height_cm (Altura do usuário) no select e no retorno.
...
// Somente admin/owner/profissional tem permissão de consultar este endpoint
if (payload.role !== 'admin' && payload.role !== 'owner' && payload.role !== 'profissional') {
...
phone: true,
active: true,
// 🎯 ADICIONADO: Seleciona o campo height_cm
height_cm: true, 
...
// 🎯 ADICIONADO: Mapeia height_cm (Int? no Prisma) para String ou null
